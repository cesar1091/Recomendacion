...
class Recomendacion:
    ...
    def clientes_call(self):
        ...
        list_client_prod = self.client_df[self.client_df['diff']==0][['CODIGOCLIENTE','CODIGOPRODUCTO','TIPOUNIDADMIN','AVGLAGUNIT']]
        list_client_prod['AVGLAGUNIT'] = np.round(list_client_prod['AVGLAGUNIT'],0)
